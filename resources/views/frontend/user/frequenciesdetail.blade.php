...
<section class="gradient-form background-radial-gradient">
    ...
    <link rel="stylesheet" href="{{ url('public/audio/styles.css') }}">
...
<script src="{{ url('public/audio/src/howler.core.js') }}"></script>
<script src="{{ url('public/audio/siriwave.js') }}"></script>
<script src="{{ url('public/audio/player.js') }}"></script>
<script>
/*!
  ...
  play: function(index) {
    ...
    if (data.howl) {
      ...
      sound = data.howl = new Howl({
        ...
        src: ['{{ url("public/images") }}/' + data.file ],
