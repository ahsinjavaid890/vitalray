                ...
                <div class="row mt-4">
                    <div class="col-md-12">
                        ...
                        <div class="googlepaydiv hideallforms mt-5 mb-5">
                            <div style="width: 100%; height: 40px;" id="container"></div>
                        </div>
                        <div class="paypalpaydiv hideallforms mt-5 mb-5">
                            <a style="height: 40px;" href="{{ url('paypalpayement') }}/{{$plan->id}}" class="btn btn-default mt-4 d-flex align-items-center justify-content-center">Pay ${{ number_format($plan->price+4, 2) }} from Paypal</a>
                        </div>
                        <form id="payment-form" class="cardpaydiv" action="{{ route('subscription.create') }}" method="POST">
                            @csrf
