    ...
    <div style="background: #386bc0;border-radius:10px" class="container  p-4">
        <div class="row">
            <div class="col-6">
                ...
                <form role="form" action="{{ url('stripepayment') }}" method="post" class="require-validation" data-cc-on-file="false" data-stripe-publishable-key="{{ env('STRIPE_KEY') }}" id="payment-form">
                     @csrf
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="row">
                        ...
                        <div class="row">
                            ...
                            <div class='form-row row'>
                               <div class='col-xs-12 col-md-4 form-group cvc required'>
                                  ...
                                  <input id="cvv" autocomplete='off'
                                     class='form-control card-cvc' placeholder='ex. 311' maxlength="4"
                                     type='text'>
                               </div>
                               <div class='col-xs-12 col-md-4 form-group expiration required'>
                                  <label class='control-label'>Expiration Month</label> 
                                  <input class='form-control card-expiry-month' maxlength="2" id="month" placeholder='MM' size='2' type='text'>
                               </div>
                               <div class='col-xs-12 col-md-4 form-group expiration required'>
                                  <label class='control-label'>Expiration Year</label> 
                                  <input class='form-control card-expiry-year' maxlength="4" id="year" placeholder='YYYY' size='4' type='text'>
                               </div>
                            </div>                  
                        </div>
                    </div>
                        <div class="row">
                            <div class="col-lg-6 text-right">
                                ...
                                <button type="submit" style="font-size: 18px" class="btn-block mt-4 btn btn-warning text-white"> Pay With Credit Card</button>
                            </div>
                        </div>
                    </form>
